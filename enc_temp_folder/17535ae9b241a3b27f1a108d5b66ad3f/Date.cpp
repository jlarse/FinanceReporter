...
namespace datelarsen
{
	...
	Date Date::operator-(const char amount)
	{
		...
		{
			//subtracts a month. if last day of curren month exceeds number of days of previous month set day to last day of previous month 
			//months with 31 days 1,3,5,7,8,10,12
			//febuary has 29 days on leap year, and 28 days on other years
			//months with 30 days 4, 6, 9, 11
			switch (month)
			...
			case 2: //months number of days <= next previous months number of days
			case 4: 
			case 6:
			case 8:
			case 9:
		...
		{
			cout << "IS 2020 leap year " << isLeapYear(2020) << endl;
			/*
			//if year is a leap year and is febuary and day is 29th donwsize the day to a non leapyear day for febuary
			if (isLeapYear() && month == 2 && day == 29)
			{
